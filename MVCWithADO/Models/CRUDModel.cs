...
namespace MVCWithADO.Models
{
    public class CRUDModel
    {
        ...
        public DataTable GetAllStudents()
        {
            ...
            string strConString =@"Data Source=KRV\KRV;Initial Catalog=MyDB;Integrated Security=True";
            using (SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["MyDB"].ToString()))
            {
                con.Open();
